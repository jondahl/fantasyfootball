...
values["rb"][3] = 20
values["rb"][4] = 18
values["rb"][5] = 18 # Woodhead occasionally (rarely). Mathews, Langford, Gore, Foster,
values["rb"][6] = 1
...
values["wr"][3] = 51 # Cobb 6/10. Watkins, Landry, Maclin. usually. Worst draft: http://www.fleaflicker.com/nfl/leagues/124678/drafts.
values["wr"][4] = 46 # Maclin, Decker or better
